...
namespace AgendaElectronica.Services.Providers
{
    public class TextosProvider:ITextosProvider
    {
        ...
        public string EncriptarTexto(string texto, string clave)
        {
            ...
            using (var password = new Rfc2898DeriveBytes(clave, saltStringBytes, DerivationIterations))
            {
